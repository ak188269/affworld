...
const URL = {
    ...
    USER_API_BASE_URL : isDevMode() ? "http://localhost:8080/api/v1/user" : "https://affworld-backend.vercel.app/api/v1/user" ,
    ...
    SECRET_API_BASE_URL : isDevMode() ? 'http://localhost:8080/api/v1/secret' : "https://affworld-backend.vercel.app/api/v1/secret" ,
    ADD_SECRET_API :  '/add',
